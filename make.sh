...
date=`date +%Y%m%d`
outputname="$romtypename-$outputtype-$sourcever-$date-ErfanGSI-TheCandyShop"
...
sed -i "s/$bdisplay/$displayid2=Built\.with\.ErfanGSI\.Tools\.TheCandyShop/" $systemdir/system/build.prop
